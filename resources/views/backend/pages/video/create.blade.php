                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="video" cols="30" rows="4" class="form-control @error('video') is-invalid @enderror">{{ old('video') }}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="inputName">Point</label>
                                <input type="text" id="inputName" class="form-control @error('point') is-invalid @enderror" name="point" value="{{ old('point') }}">
                            </div>
                        </div>
                        <!-- /.card-body -->
                    </div>
