                        ...
                        <tr>
                            ...
                            <td class="project-actions text-center">
                                <a class="btn btn-info btn-sm" href="" data-toggle="modal" data-target="#accept{{ $item->id }}">
                                    <i class="fas fa-check pencil-alt ">
                                    </i>
                                    Approve
                                </a>
                                            ...
                                            <form action="{{ route('payment.approve',$item->id) }}" method="POST">
                                                ...
                                                <div class="modal-body" style="text-align: left">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" disabled value="{{ $item->payment_number }}" class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" disabled value="@if ($item->payment_method==1) Bkash @elseif ($item->payment_method==2) Nagad @else Rocket @endif" class="form-control">
                                                    </div>
                                                    <hr>
                                                    <div class="form-group">
                                                        <label for="">Transection ID</label>
                                                        <input type="text" value="" name="transection_code" class="form-control">
                                                    </div>
